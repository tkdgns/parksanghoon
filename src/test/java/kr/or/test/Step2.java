...
class MemberVO{
	...
	//맴버변수는 보안떄문에 private만들었으나, get,set메서드는 public으로 생성됩니다.
...
class MemberService {//회원출력에 관련된 메서드를 모아 놓습니다.(아래)
...
public class Step2 {
	...
	public static void main(String[] args) {
		...
		//위 각각 3개의 레코드 1군데  담을 배열 클래승 오브젝트를 하나 생성
		MemberVO[] members = new MemberVO[3];
		members[0] = memberVO;
		members[1] = memberVO2;
		members[2] = memberVO3;
		//전에 사용했던 출력보다는 개선된 방식으로 출력(아래)
